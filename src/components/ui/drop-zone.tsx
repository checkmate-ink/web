...
function DropZone({
  ...
  return (
    <div
      data-slot="drop-zone"
      className={cn(
        "relative flex h-65 w-full items-center justify-center rounded-2xl border-3 border-dashed border-deep-brown/30 transition-colors",
    ...
    >
      ...
      <div className="flex flex-col items-center gap-3.5">
        <CloudUpload className="size-10 text-deep-brown opacity-35" />
        <div className="flex flex-col items-center gap-1">
          <p className="text-md font-medium text-deep-brown">{t("title")}</p>
